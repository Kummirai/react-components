...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-[#070b15]">
      {/* Top fade gradient */}
      <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-transparent to-[#070b15] z-10 pointer-events-none" />
